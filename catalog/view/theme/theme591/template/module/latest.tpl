			...
			<div>
				...
				<div class="quick_info">
							...
							<div class="left col-sm-4">
								...
								<div class="right col-sm-8">
									...
									<div class="cart-button">
										...
										<button class="btn btn-icon" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa  fa-retweet"></i></button>
					...
					<div class="cart-button">
						...
						<button class="product-btn" type="button" title="" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa  fa-retweet"></i><span><?php echo $button_compare; ?></span></button>
						<button class="product-btn" type="button" title="" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i><span><?php echo $button_wishlist; ?></span></button>
						</div>
					</div>
						<div class="clear"></div>
				</div>
